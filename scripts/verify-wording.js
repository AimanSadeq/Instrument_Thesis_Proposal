 ...
 * docs/source/Research_Instruments_v2.3.md.
 *
...
const DOC = path.join(__dirname, '..', 'docs', 'source', 'Research_Instruments_v2.3.md');
...
console.log(`\n${strings.length} strings checked against Research Instruments v2.3.`);
